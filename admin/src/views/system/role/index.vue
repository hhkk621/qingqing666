      ...
      >
        ...
        <el-table-column label="操作" default="scope">
          <template #default="scope" >
            ...
            <el-button type="danger" size="small" @click="deleteOne(scope.row)" v-if="scope.row.rid!==1">删除</el-button>
            <el-button type="warning" size="small" @click="authMenu(scope.row)"  v-if="scope.row.rid!==1">分配菜单</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-row>
